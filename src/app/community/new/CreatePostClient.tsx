...
export default function CreatePostClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Form data:', {
      ...
      caption,
      visibility,
      media_urls: images.length,
      ingredients: ingredients.filter(i => i.trim()).length,
      instructions: instructions.filter(i => i.trim()).length,
    });
    ...
    try {
      ...
      const totalTime = (prepTime && cookTime) 
        ...
        : prepTime ? Number(prepTime) : cookTime ? Number(cookTime) : undefined;
  ...
  return (
    <div className="community-create-page">
      <div className="community-create-form">
        <form onSubmit={handleSubmit} className="community-neon-card" style={{
          padding: 'var(--pad-lg)',
          borderRadius: '20px',
